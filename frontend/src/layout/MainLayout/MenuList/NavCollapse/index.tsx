...
export default function NavCollapse({ menu, level, parentId }: NavCollapseProps) {
    ...
    const handleClickMini = (event: MouseEvent<HTMLDivElement> | undefined) => {
        setAnchorEl(null);
        if (drawerOpen) {
            setOpen(!open);
    ...
    useMenuCollapse(menu as any, pathname, openMini, setSelected as any, setOpen, setAnchorEl as any);
    ...
    return (
        <>
            <ListItemButton
                ...
                selected={isSelected}
                {...(!drawerOpen && { onMouseEnter: (e: any) => handleClickMini(e), onMouseLeave: handleMiniClose })}
            ...
            >
                ...
                {!drawerOpen && (
                    ...
                    >
                        {({ TransitionProps }) => (
                            <Transitions sx={{ overflow: 'visible' }} in={openMini} {...TransitionProps}>
                                <Paper
                                    sx={{
                                        overflow: 'hidden',
