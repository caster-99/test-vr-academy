...
function ElevationScroll({ children, window }: ElevationScrollProps) {
    ...
    return cloneElement(children, {
        style: {
            backgroundColor: (theme as any).vars?.palette.background.default || theme.palette.background.default,
            color: (theme as any).vars?.palette.text.dark || theme.palette.text.primary
        }
    });
}
                ...
                <Container>
                    <Toolbar sx={{ py: 2.5, px: `0 !important` }}>
                        ...
                        <Stack direction="row" sx={{ gap: { xs: 1.5, md: 2.5 }, display: { xs: 'none', sm: 'flex' } }}>
                            ...
                            <Button component={Link} href="https://links.codedthemes.com/hsqll" disableElevation variant="contained" color="secondary" target="_blank">
                                Purchase Now
                            </Button>
                        </Stack>
